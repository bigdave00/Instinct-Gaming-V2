...
Config = {
	...
	Locations = {
		...
		{ -- GabzTuners Radio Prop
			...
			DefaultVolume = 0.1,
			radius = 100,
			coords = vector3(75.574, -1740.766, 29.614),
			---prop = `ch_prop_arcade_jukebox_01a`	-- Prop to spawn at location, if the location doesn't have one already
			soundLoc = vector3(64.91, -1754.41, 29.61),						-- (can be changed to any prop, coords determine wether its placed correctly)
		},
		...
		{ -- LostMC compound next to Casino
			...
			DefaultVolume = 0.1,
			radius = 20,
			coords = vec3(-770.522, -17.532, 44.779),
			soundLoc = vector3(-774.03, -10.42, 43.75), -- Add sound origin location if you don't want the music to play from the dj booth
		},
	},
}
