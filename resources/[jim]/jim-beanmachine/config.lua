...
Config = {
	...
	FoodItems = {
		...
		slots = 8,
		items = {
			{ name = "water", price = 0, amount = 50, info = {}, type = "item", slot = 1, },
...
Crafting = {
	Slush = {
		{ ['bigfruit'] = { ['watermelon'] = 1, ['water'] = 1, ['orange'] = 1, ['sugar'] = 1, }, },
	},
	Drinks = {
		{ ['highnoon'] = { ['beancoffee'] = 1, ['water'] = 1, ['orange'] = 1, }, },
		{ ['speedball'] = { ['beancoffee'] = 3, ['sugar'] = 1, }, },
		{ ['gunkaccino'] = { ['beancoffee'] = 1, ['sugar'] = 2, ['cheesecake'] = 1, }, },
		{ ['bratte'] = { ['beancoffee'] = 2, ['sugar'] = 5, }, },
		{ ['flusher'] = { ['beancoffee'] = 1, ['water'] = 1, ['orange'] = 1, ['chickenbreast'] = 1, }, },
		{ ['ecocoffee'] = { ['beancoffee'] = 1, ['water'] = 1, ['milk'] = 1, ['plastic'] = 1, }, },
