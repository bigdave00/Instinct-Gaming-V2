...
Config.Locations = {
	...
	{   job = "mechanic",
		zones = {
			vector2(108.07023620605, -1768.5142822266),
			vector2(83.537239074707, -1798.3922119141),
			vector2(47.868698120117, -1790.2329101562),
			vector2(27.883682250977, -1773.9265136719),
			vector2(70.835266113281, -1722.6077880859)
		},
		autoClock = { enter = false, exit = false, },
		stash = { { coords = vector4(82.018, -1758.411, 29.614, 0.0), w = 4.0, d = 1.0, },
		          { coords = vector4(79.195, -1756.05, 29.614, 0.0), w = 4.0, d = 1.0, },
				  { coords = vector4(78.147, -1742.74, 29.614, 0.0), w = 4.0, d = 1.0, },
				  { coords = vector4(76.651, -1792.462, 29.614, 0.0), w = 4.0, d = 1.0, },
				  { coords = vector4(71.877, -1788.212, 29.614, 0.0), w = 4.0, d = 1.0, }, },
		store = { { coords = vector4(84.16, -1740.39, 29.655, 0.0), w = 5.5, d = 1.0, }, },
		crafting = { { coords = vector4(101.791, -1776.156, 29.434, 0.0), w = 0.6, d = 1.0, },
		             { coords = vector4(96.521, -1782.413, 29.495, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(91.394, -1788.606, 29.406, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(86.171, -1794.819, 29.414, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(67.643, -1779.35, 29.414, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(72.787, -1773.045, 29.415, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(78.152, -1766.922, 29.414, 0.0), w = 0.6, d = 1.0, }, 
					 { coords = vector4(71.764, -1761.445, 29.414, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(66.741, -1767.486, 29.414, 0.0), w = 0.6, d = 1.0, }, 
					 { coords = vector4(61.395, -1773.843, 29.414, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(55.946, -1780.286, 29.414, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(50.631, -1786.72, 29.414, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(31.276, -1770.44, 29.42, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(36.689, -1764.079, 29.42, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(41.889, -1757.61, 29.415, 0.0), w = 0.6, d = 1.0, },
					 { coords = vector4(47.126, -1751.393, 29.415, 0.0), w = 0.6, d = 1.0, }, },
		clockin = { { coords = vector4(81.858, -1735.291, 29.514, 0.0), prop = false, }, },
		--manualRepair = { { coords = vector4(914.8, -2126.59, 30.11, 265.62), prop = true, } },
			garage = { spawn = vector4(40.836, -1712.31, 29.303, 0.0),
					out = vector4(49.151, -1703.453, 29.303, 0.0),
					list = { "towtruck", "energytruckmec", "energynissanmec", "energyafricatmec" } },
		payments = { coords = vector4(54.289, -1746.363, 29.693, 0.0),
			img = "<center><p><img src=https://cdn.discordapp.com/attachments/1145688306529607760/1145689427264421888/Instinct-no-backgound.png width=150px></p>",
			prop = true, },
		blip = vector3(86.08, -1764.47, 29.61),
		bliplabel = "IG Mechanics",
		blipcolor = 57,
		discordlink = "",
		discordcolour = 39135,
		discordimg = "https://cdn.discordapp.com/attachments/1145688306529607760/1145689427264421888/Instinct-no-backgound.png",
	},
}
