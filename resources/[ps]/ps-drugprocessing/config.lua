...
Config.CircleZones = {
	...
	HydrochloricAcidFarm = {coords = vector3(3542.8, 2548.99, 6.31), name = ('Hydrochloric Acid'), radius = 100.0},

	SulfuricAcidFarm = {coords = vector3(-1808.73, 5504.53, 11.45), name = ('Sulfuric Acid'), radius = 100.0},
	SodiumHydroxideFarm = {coords = vector3(-1735.97, -235.21, 54.43), name = ('Sodium Hydroxide'), radius = 100.0},
	
	ChemicalsField = {coords = vector3(-468.77, 1526.64, 391.24), name = ('Chemicals'), radius = 100.0},
	ChemicalsConvertionMenu = {coords = vector3(3536.71, 3662.63, 28.12), name = ('Chemicals Process'), radius = 100.0},

	CokeField = {coords = vector3(3259.75, -151.26, 18.03), name = ('Coke'), radius = 100.0},
...
Config.CokeProcessing = {
	CokeLeaf = 2, -- Amount of Leaf Needed to Process
	ProcessCokeLeaf = math.random(13), -- Amount of Coke Received
	-- Processing Small Bricks --
	Coke = 6, -- Amount of Coke Needed for Small Brick
	BakingSoda = 2, -- Amount of Baking Soda Needed for Small Brick
	SmallCokeBrick = math.random(1),
	-- Process Small Bricks Into Large Brick --
	SmallBrick = 3, -- Amount of Small Bricks Required
...
Config.MethProcessing = {
	...
	Meth = math.random(1), -- Amount of Meth Recevied From 1 Tray
}
