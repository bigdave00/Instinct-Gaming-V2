...
clib_API.ThirdEye = {
    ...
    RemoveModelInteraction = function(properties)
        ...
        elseif clib_Config.public.Target == "ox" then
            exports.ox_target:RemoveTargetModel(properties.modelHash, string.split(properties.event, ":")[2])
        else
            -- 🔧 If using custom, implement your own code here
        end
    end,
    ...
    AddTargetBone = function(properties)
        ...
        elseif clib_Config.public.Target == "oxs" then
            exports.ox_target:AddTargetBone(properties.bones, {
                {
                    name = string.split(properties.event, ":")[2],
                    event = properties.event,
                    payload = properties.payload,
