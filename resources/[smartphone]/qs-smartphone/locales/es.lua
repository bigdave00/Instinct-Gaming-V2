Locales['es'] = {
    ...
    ["BANK_TRANSFER"] = "Te transfirieron $%s",
    ["BANK_MISSING_IBAN"] = "Sin iban",
    ...
    ["UBERDRIVER_AVAILABLE"] = "DriveNow disponibles:",
    ...
    ["UBERDRIVER_NOT_A_DRIVER"] = "No eres un controlador DriveNow",
    ...
    ["UBERDRIVER_ALREADY_UBER"] = "Eres DriveNow, no puedes llamar a un auto",
    ...
    ["WHATSAPP_GROUP_TITLE"] = "ChitChat Group",
    ...
    ["UBER_TITLE"] = "doorRun come",
    ["CANT_DO_THIS"] = "No puedes hacer esto!",
    ["UBER_ACTIVE"] = "doorRun Activo",
    ["UBER_DISABLED"] = "doorRun deshabilitado",
    ...
    ["CALENDAR_INFORMATION"] = "Hoy es:",

    ["WEAZEL_NEWS_NEW"] = "Nueva noticia!",
}