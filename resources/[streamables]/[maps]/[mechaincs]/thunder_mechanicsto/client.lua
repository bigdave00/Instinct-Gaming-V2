local clearVehiclesMechanicStoThunderShop = true  --if you don't want NPC riding a car passing through the MechanicThunderShop, put = true
local clearPedsMechanicStoThunderShop = true --if you don't want NPC passing through the MechanicThunderShop, put = true

CreateThread(function()

    while clearVehiclesMechanicStoThunderShop do 
        ClearAreaOfVehicles(65.65, -1767.19, 29.57, 250.0, false, false, false, false, false) -- 
        Wait(250)
    end 
end)
...
CreateThread(function()
    ...
    while clearPedsMechanicStoThunderShop do 
        ClearAreaOfPeds(65.65, -1767.19, 29.57, 250.0, 1)
        Wait(250)
    end 
end)
