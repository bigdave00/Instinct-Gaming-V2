...
--- WC SEPARATED 
    ...
    ["fort2"] = {"custom@salsa", "salsa", "Custom Fort 2", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ...
    ["fort4"] = {"custom@maraschino", "maraschino", "Custom Fort 4", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["fort5"] = {"custom@makarena", "makarena", "Custom Fort 5", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["fort6"] = {"custom@gangnamstyle", "gangnamstyle", "Custom Fort 6", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ...
    ["fort9"] = {"custom@armwave", "armwave", "Custom Fort 9", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ...
    ["nekotest89"] = {"anim@move_hostages@male", "male_idle_to_cower", "Custom test89", AnimationOptions =
    {   
        EmoteLoop = false,
        EmoteMoving = false,
    ...
    ["zsturdy"] = {"divined@drillb2@new", "sturdy", "Get Sturdy #1", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ...
    ["zsturdyground"] = {"divined@drillb2@new", "sturdyground", "Get Sturdy #2", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ...
    ["zdancesolo"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_09_v1_male^4", "Dance Solo ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zdancesolo3"] = {"special_ped@mountain_dancer@base", "base", "Dance Solo 3 ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zdancesolo4"] = {"anim@mp_player_intcelebrationfemale@raise_the_roof", "raise_the_roof", "Dance Solo 4 ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zdancepartyf"] = {"anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v1_female^1", "Dance Party Female ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zdancepartyf2"] = {"anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v1_female^6", "Dance Party Female 2 ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zdanceparty3"] = {"anim@mp_player_intcelebrationfemale@heart_pumping", "heart_pumping", "Dance Party 3 ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ...
    ["zdancedisco"] = {"anim@mp_player_intcelebrationfemale@uncle_disco", "uncle_disco", "Dance Disco ~y~ Gangbanger v3", AnimationOptions =
    {
       EmoteLoop = true,
    }},
    ["zlaying"] = {"timetable@ron@ig_3_couch", "laying", "Laying ~y~ Gangbanger v3", AnimationOptions =  
    {
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zcrouch"] = {"combat@chg_stance", "crouch", "Crouch ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zcarsleep"] = {"mp_cp_stolen_tut", "dazed", "Slep In Car ~y~ Gangbanger v3", AnimationOptions =  
    {  
       EmoteMoving = false,
       EmoteLoop = true,
    }},
    ["zhandsup2"] = {"mp_defend_base", "guard_handsup_loop", "Hands Up 2 ~y~ Gangbanger v3", AnimationOptions =  
    {  
    EmoteMoving = false,
     EmoteLoop = true,
    }},
...
DP.White3ro = {
    ...
    ["sport"] = {"perlenfuchs@sport_2", "sport_2_clip", "Sport", AnimationOptions =
    {
       ...
       ["wall2"] = {"walk2@spider", "walll2_clip", "~r~ Wall2", AnimationOptions =
       {
        EmoteLoop = true,
        EmoteMoving = false,
       }},
       ["walk2"] = {"walk2@spider", "walk2_clip", "~r~ Walk2", AnimationOptions =
       {
        EmoteLoop = true,
        EmoteMoving = false,
       }},
       ...
       ["mopose"] = {"smokeandlean@animation", "smokeandlean_clip", "Chill Pose~r~(Mo)", AnimationOptions =
       {
           EmoteMoving = false,
           EmoteLoop = true,
       }},
       ...
       ["custom76"] = {"hassanblood@animation", "hb_clip", "Custom76", AnimationOptions =
       {
           EmoteLoop = true,
           EmoteMoving = false,
       }},
       ...
       ["custom99"] = {"doubleo@animation", "doubleo_clip", "Custom99", AnimationOptions =
       {
           EmoteLoop = true,
       }},
       ...
       ["custom113"] = {"ceek2animation", "ceek2_clip", "Custom113", AnimationOptions =
       {
           EmoteLoop = true,
       }},
       ["custom114"] = {"foek1animation", "foek1_clip", "Custom114", AnimationOptions =
       {
           EmoteLoop = true,
       }},
       ...
       ["custom158"] = {"divined@rpack@new", "bunnyhop", "Custom158", AnimationOptions =
       {
           EmoteLoop = true
       }},
       ["custom159"] = {"divined@rpack@new", "burpee", "Custom159", AnimationOptions =
       {
           EmoteLoop = true
       }},
       ...
       ["custom166"] = {"divined@rpack@new", "uproar", "Custom166", AnimationOptions =
       {
           EmoteLoop = true
       }},
