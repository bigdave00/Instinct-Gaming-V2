...
Config = {
	...
	RenewedBanking = false, -- Enable if using Renewed-Banking false if using qb-core-management
	...
	Jobs = {
		['beanmachine'] = { MinAmountforTicket =50, PayPerTicket = 0, Commission = 0, },
		['bakery'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0.10, },
		['burgershot'] = { MinAmountforTicket = 50, PayPerTicket = 10 , Commission = 0, },
		['uwu'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['henhouse'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['pizzathis'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['popsdiner'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, }, 
		['bahama'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, }, 
		['tequilala'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['vanilla'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['bennys'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['igmechanic'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['mechanic'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['aa'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, },
		['lostmc'] = { MinAmountforTicket = 50, PayPerTicket = 10, Commission = 0, gang = true, }, -- Example of a gang being supported
	},
