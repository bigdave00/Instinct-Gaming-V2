...
if Config.Inv == "ox" then
	function HasItem(src, items, amount)
		local count = exports.qb-inventory:Search(src, 'count', items)
		if exports.qb-inventory:Search(src, 'count', items) >= (amount or 1) then if Config.Debug then print("^5Debug^7: ^3HasItem^7: ^5FOUND^7 x^3"..count.."^7 ^3"..tostring(items)) end return true
