...
AddEventHandler('housing:server:buyHouse', function(house, isCredit)
    ...
    if Config.LimitOfHouses == 0 or houses < Config.LimitOfHouses then
        ...
        local eq = HousePrice * Config.CreditEq
        ...
        if (Balance >= HousePrice) or (isCredit and Balance >= eq) then -- here
            ...
            MySQL.Async.execute('INSERT INTO `player_houses` (`house`, `' .. identifierTypes .. "`, `houseID`, `keyholders`, `credit`, `creditPrice`) VALUES ('" .. house .. "', '" .. pData.identifier .. "', '" .. house_ID .. "', '" .. json.encode(keyyeet) .. "', '" .. prices .. "', '" .. eq .. "')", {})
