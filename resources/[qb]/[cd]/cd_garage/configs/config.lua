...
Config.Impound = {
    ...
    Impound_Fee = { --This is the price players pay for their vehicle to be unimpounded.
        ...
        default_price = 150, --If 'default' method is chosen, then it will be a set price to unimpounded any vehicle. (eg., $1000 fee).
...
Config.TransferGarage = {
    ...
    transfer_fee = 65 --The cost per vehicle garage transfer ^.
}
...
Config.JobVehicles = {
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `x5arv`},
            [2] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedxc90`},
            [3] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedx5`},
            [4] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedsvr`},
            [5] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `m5arv`},
            [6] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `lrkeeyz`},
            [7] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedintar`},
            [8] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `touregarv`},
            [9] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `sixinterceptor`},
            [10] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `skodaair`},
            [11] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `marked540i`},
            [12] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `marked330d`},
            [13] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `ucx5`},
            [14] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `uc_v90`},
            [15] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `uc_rs`},
            [16] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `uc_bmw340`},
            [17] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `tesmsu`},
            [18] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `tesmsm`},
            [19] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `skosuperb`},
            [20] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `rangoraptor`},
            [21] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `poltransit`},
            [22] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `poltoyota`},
            [23] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `pols3`},
            [24] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polrs3`},
            [25] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polrover`},
            [26] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polriot`},
            [27] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polpeugeot`},
            [28] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polm522`},
            [29] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `policebike`},
            [30] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polhyundai`},
            [31] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polbike`},
            [32] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `pdbmwg21`},
            [32] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `owenskoda`},
            [33] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `outlander`},
            [34] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `osbornekia`},
            [35] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `monaghanamg`},
            [36] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedx1`},
            [37] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedwrx`},
            [38] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedvxr`},            
            [39] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedvwp`},
            [40] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedvw`},
            [41] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedv90`},
            [42] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedV60`},
            [43] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedv40`},
            [44] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedtour`},
            [45] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedsko`},
            [46] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markeds5`},
            [47] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedq7`},
            [48] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedmon`},
            [49] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedmk5`},
            [50] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedmirai`},
            [51] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedm5`},
            [52] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedm2`},
            [53] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedlr`},
            [54] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedi3`},
            [55] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedfpace`},
            [56] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedfordr`},
            [57] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedevo`},
            [58] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedcla45`},
            [59] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedbmw3`},
            [60] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markeda6`},
            [61] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `marked308`},
            [62] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `g31`},
            [63] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `g30`},
            [64] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `fordfocusarv`},
            [65] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `3008suv`},
            [66] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `ncaxclass`},
            [67] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `ncasprinter`},
            [68] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `prisonlorry`},
            [69] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `dogs01`},
            [70] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `unmarkedrs7r`},
            [71] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `unmarkedm135`},
            [72] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `unmarkedm3`},
            [73] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `markedjag`},
            [74] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `m7comp`},
            [75] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `m5cs21`},
            [76] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `levantesq4`},
            [77] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `kawasaki`},
            [78] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `jagmcs`},
            [79] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `gle`},
            [80] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `gct2`},
            [81] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `g20unmarked`},
            [82] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `e63p`},
            [83] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `disco`},
            [84] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `cupraunm`},
            [85] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `Chrisken`},
            [86] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `brabus800e`},
            [87] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `benx5`},
            [88] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `v250`},
            [89] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `X5JRU`},

            [90] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'boat', model = `policerhib`},
            [91] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'boat', model = `policeboat`},

            [92] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'air', model = `npas`},
            [93] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `segway`},
        },
        ['ambulance'] = {
            [1] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `17wasambo`},
            [2] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `CSU`},
            [3] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `goldskoda`},
            [4] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `hartcommand`},
            [5] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `LAStiguan`},
            [6] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsambu`},
            [7] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsambul`},
            [8] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsbike`},
            [9] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsbike1`},
            [10] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsbmw`},
            [11] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsdoctor`},
            [12] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsfiatvan`},
            [13] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsgold`},
            [14] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsincident`},
            [15] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsrange`},
            [16] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsrrbike`},
            [17] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhssilver`},
            [18] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsskodavrs`},
            [19] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsv90`},
            [20] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsvolvo`},
            [21] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsvrs`},
            [22] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsvw`},
            [23] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsx5`},
            [24] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsxc90`},
            [25] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `ParaRS`},
            [27] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `sprinteram`},
            [27] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `unmarkeddef`},
            [27] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `utv1`},
            [27] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `VRSKodiaq`},
            [27] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `X5JRU`},

            [33] = {job = 'ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'air', model = `nhsheli`},
...
Config.GangGarages = {
    ...
    Locations = {
        ...
        [2] = {gang = 'soa', garage_id = 'Sons Of Anarchy', coords = vector3(964.64, -118.36, 74.35), spawn_coords = vector4(958.56, -112.99, 74.4, 227.9), distance = 10, garage_type = 'car'}, -- Lost MC Compound Next to Casino
        ...
        [7] = {gang = 'davisgang', garage_id = 'Davis Gang', coords = vector3(1274.26, -1733.27, 51.98), spawn_coords = vector4(1285.03, -1730.86, 52.9, 112.52), distance = 5, garage_type = 'car'}, -- Lost MC Compound Next to Casino
    },
}
