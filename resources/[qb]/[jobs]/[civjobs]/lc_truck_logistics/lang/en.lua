...
Lang['en'] = {
	...
	['loading_fail'] = "Your cargo is taking longer than usual to load. Have you installed the truck mods? Read the readme for install instructions",
	['too_damaged'] = "This truck is too damaged, repair it",
