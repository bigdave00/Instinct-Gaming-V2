...
Lang['de'] = {
	...
	confirmation_modal_sell_vehicle: 'Sind Sie sicher, dass Sie dieses Fahrzeug verkaufen möchten?',
	confirmation_modal_delete_party: 'Sind Sie sicher, dass Sie diese Gruppe löschen möchten?',

	statistics_page_title: 'Statistiken',
	statistics_page_desc: 'Statistiken Ihrer LKW-Firma',
	...
	contract_page_desc: 'Hier brauchen Sie keinen eigenen LKW. Die Firma stellt alles für Sie bereit.',
	contract_page_title_freight: 'Fracht',
	contract_page_desc_freight: 'Verdienen Sie mehr Geld durch Fracht mit Ihrem eigenen LKW.',
	...
	diagnostic_page_desc: 'Reparieren Sie Ihren LKW, um Aufträge ausführen zu können (wechseln Sie Ihren LKW, indem Sie auf die Schaltfläche "Auswählen" auf der Seite "Lastwagen" klicken)',
	...
	trucks_page_desc: 'Sehen Sie hier alle Ihre Lastwagen. Sie können für jeden Fahrer einrichten',
	...
	mydrivers_page_desc: 'Hier finden Sie alle Ihre Fahrer. Sie können für jeden Fahrer einen LKW einrichten',
	
	drivers_page_title: 'Rekrutierungsbüro',
	drivers_page_desc: 'Rekrutieren Sie neue Fahrer, die für Ihre Firma arbeiten',
	...
	drivers_page_valuable: 'Wertvolle',
	drivers_page_fragile: 'Zerbrechliche',
	drivers_page_urgent: 'Dringend',
	drivers_page_hire_button: 'ANWERBEN',
	drivers_page_driver_fuel: 'Kraftstoff',
	drivers_page_fire_button: 'Feuerwehrfahrer',
	drivers_page_refuel_button: 'LKW füllen {0}',
	drivers_page_pick_truck: 'Wählen Sie einen LKW',
	
	skills_page_title: 'Fähigkeiten',
    skills_page_desc: 'Durch Arbeit sammeln Sie wertvolle Erfahrungen. Je mehr Strecke Sie zurücklegen, desto mehr Erfahrung sammeln Sie. Letztendlich verdienen Sie auf diese Weise Fähigkeitspunkte, die Sie hier zuweisen können, um Ihre LKW-Fähigkeiten hervorzuheben. (Verfügbare Fähigkeitspunkte: {0})',
    skills_page_description: 'Beschreibung',
    skills_page_product_type_title: 'Produkttyp (ADR)',
	skills_page_product_type_description: `
		<p>Der Transport gefährlicher Güter erfordert gut ausgebildete Fachleute. Kaufen Sie ADR-Zertifikate, um neue Arten von Fracht freizuschalten.</p>
		<ul>
	...
	bank_page_desc: 'Hier können Sie die Bankkontoinformationen Ihres Unternehmens einsehen',
	...
	bank_page_loan_desc: 'Nehmen Sie Kredite für Ihr Unternehmen auf! <BR> (Höchstbetrag für Darlehen: {0})',
	...
	bank_page_withdraw_modal_desc: 'Wie viel möchten Sie abheben?',
