...
Config = {
    ...
    -- You can add as many pepper sprays as you want in this table!
        ['pepperspray'] = {
            ...
            sprayQuantity = 750, -- Quantity of spray
            sprayDescent = 15, -- Time in milliseconds to lower the recovery rate (The higher the number, the longer the time)
            ...
            splitDescent = 7, -- How many percent when you spit the recovery rate will decrease
            splitTimeout = 10000, -- Time in milliseconds to spit again

            rubbingEnabled = true, -- Active or not for rubbing the eyes
            rubbingDescent = 4.0, -- The above descentSpeed will be divided into this number when you rub your eyes
    ...
    Decontamination = {
        ...
        decontaminationQuantity = 1000, -- Quantity of decontamination spray
