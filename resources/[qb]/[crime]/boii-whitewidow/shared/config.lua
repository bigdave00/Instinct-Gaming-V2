...
Config.CoreSettings = {
    ...
    PhoneEvent = 'qs-smartphone:RefreshPhone', -- The name of your phone event this is needed for billing. Default; 'qb-phone:RefreshPhone'
    ClothingEvent = 'illenium-appearance:client:openOutfitMenu', -- The name of your clothing event this is needed to open outfit menu. Default; 'qb-clothing:client:OpenOutfitMenu'
...
-- MLO version toggle
Config.MLOVersion = 'v1' -- MLO Version options; 'v1' or 'v2' -- 'v2' = https://mosbaekdesign.com/vare/white-widow-cannabis-cafe-shop-mlo-v2-update/
-- Job settings
Config.JobSettings = {
    ...
    Stores = {
        JobStore = {
            ...
            [9] = { name = 'gummybearmould',       	    price = 0, amount = 1000, info = {}, type = 'item', slot = 9 }, -- Required
        },
