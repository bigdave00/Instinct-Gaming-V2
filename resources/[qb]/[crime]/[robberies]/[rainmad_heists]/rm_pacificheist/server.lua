...
local start = false
discord = {
    ['webhook'] = 'https://discord.com/api/webhooks/961952334575968310/6rhW3eYQw4I1zAVHRSSRfh9QRP8Kh8cP_dkcasbC01TdsOgLUNCqOOopQ4nBv1-gRxVB',
        ...
        if type == 'money' then
            ...
            if dist > 200.0 then
                ...
                if Config['PacificHeist']['black_money'] then
                    player.Functions.AddItem('dirtycash', count)
                    TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['dirtycash'], "add")
