...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        {itemName = 'goldbar', sellPrice = 1000},
        {itemName = 'diamond', sellPrice = 1000},
        {itemName = 'diamond', sellPrice = 1000},
    },
    ...
    ['painting'] = {
        {
            ...
            paintingPrice = '3200', -- price of the reward item for sell
...
Strings = {
    ...
    ['start_heist2'] = 'Required things for robbery: Laptop, Hack USB, Cutter,6 C4-Bombs, 4 Thermite, Bag, Drill',
    ...
    ['wait_nextrob'] = 'There is a cooldown, timeleft -',
    ['minute'] = 'minute.',
    ...
    ['need_switchblade'] = 'You need to hold a switchblade.',
