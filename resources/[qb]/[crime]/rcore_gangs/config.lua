...
-- 2 = OverExtended Inventory (qb-inventory)
...
Config.GangOptions = {
    ...
    maxMembers = 50, -- Maximum number of players in a gang
...
Config.DrugOptions = {
    ...
    saleRandomQuantity = true, -- Enables the randomization of the amount of drugs that the player will sell
...
Config.Drugs = {
    CATEGORY_LOW = {
        ...
        ['weed_gelato_cbd'] = 50,
        ['weed_og-kush_cbd'] = 45,
        ['weed_purple-haze_cbd'] = 50,
        ['weed_skunk_cbd'] = 55,
        ['weed_white-widow_cbd'] = 35,
        ['weed_zkittlez_cbd'] = 62,
    },
    CATEGORY_MED = {
        ['meth'] = 88,
        ['crack_baggy'] = 70,
...
Config.DrugSaleMultipliers = {
    ...
    { sold = 30, multiply = 1.2 },
    { sold = 45, multiply = 1.2 },
    { sold = 50, multiply = 1.2 },
    { sold = 60, multiply = 1.2 },
    { sold = 70, multiply = 1.2 }
}
