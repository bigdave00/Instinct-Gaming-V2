...
RegisterNetEvent("illenium-appearance:client:migration:load-illenium-appearance-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent("illenium-appearance:client:migration:load-illenium-appearance-clothes", playerSkin, cache.ped)
        SetModelAsNoLongerNeeded(model)
    end)
end)

RegisterNetEvent("illenium-appearance:client:migration:load-illenium-appearance-clothes", function(playerSkin, ped)
    ...
    TriggerServerEvent("illenium-appearance:server:migrate-illenium-appearance-skin", playerSkin.citizenid, appearance)
end)
