...
Config.Language = {
    ["eatBaitText"] = "You've lost your fishing lure.",
    ["catchFish"] = "you caught!",
    ["youCantFishHere"] = "You can't fish here!",
    ["somethingStoppingFish"] = "Something's keeping you from fishing",
    ["movementOnRod"] = "There's movement on your hook!",
    ["missedFish"] = "You missed the fish",
    ["noLeftBait"] = "There is no bait left on the hook!",
...
Config.fishBaits = { -- FISH BAITS AND FEED TYPES
    ...
    {itemName = "fishbait", baitType = "illegal"},
}
...
Config.buyMarketItems = { -- LIST OF ITEMS SOLD IN THE FISH MARKET (BUY MENU)
    ...
    {itemId = 3, itemName = "fishbait", itemLabel = "Fish Bait", itemPrice = 30, image = './css/imgs/fishbait.png'},
}
...
Config.Fishes = { -- /FISH MENU SETTINGS
    {
        ...
        description = "You can catch this fish in the sea, you need a fishing rod of level 1 and above to catch this fish!"
    },
    {
        ...
        description = "You can catch this fish in the sea, to catch this fish you need a fishing rod of level 2 and above!"
    },
    {
        ...
        description = "You can catch this fish in the sea, you need a fishing rod of level 3 and above to catch this fish!"
    },
    {
    ...
    },
    {
        ...
        description = "You can catch this fish in the sea, you need a fishing rod of level 4 and above to catch this fish!"
    },
    {
        ...
        description = "You can catch this fish in the sea, you need a fishing rod of level 5 and above to catch this fish!"
    },
    {
    ...
    },
    {
        ...
        fishName = "Trouser Fish", -- THE APPARENT NAME OF THE FISH
