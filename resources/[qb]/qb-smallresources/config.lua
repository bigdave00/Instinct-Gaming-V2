...
Config.Discord = {
    ...
    ["ApplicationId"] = '1140988201083875470', -- The discord application id
    ["IconLarge"] = 'igrp', -- The name of the large icon
    ["IconLargeHoverText"] = 'Instinct Gaming V2', -- The hover text of the large icon
    ["IconSmall"] = 'igrp', -- The name of the small icon
    ["IconSmallHoverText"] = 'Instinct Gaming V2', -- The hover text of the small icon
    ...
    ["Buttons"] = {
        {
            ...
            url = 'fivem://connect/cfx/43aad9'
        },
        {
            text = 'Join the Discord!',
            url = 'discord.gg/instinctgaming'
        }
    }
}
